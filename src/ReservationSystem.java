...
public class ReservationSystem {
    ...
    public void addEventToTotalList(Event event) {
        System.out.println("Adding event to total list");
        allEventsList.add(event);
        System.out.println("Event added to total list");
        System.out.println("Total number of events: " + allEventsList.size());
        System.out.println();
    }
    public void addCustomerToTotalList(Customer customer) {
        System.out.println("Adding customer to total list");
        allCustomersList.add(customer);
        System.out.println("Customer added to total list");
        System.out.println("Total number of customers: " + allCustomersList.size());
        System.out.println();
    }
